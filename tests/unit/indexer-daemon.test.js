...
describe('package version 2.0.6', () => {
  it('is 2.0.6 in package.json, lockfile, and startup logs', () => {
    expect(pkg.version).toBe('2.0.6')
    expect(lock.version).toBe('2.0.6')
    expect(lock.packages[''].version).toBe('2.0.6')
