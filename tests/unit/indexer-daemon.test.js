...
describe('package version 2.0.3', () => {
  it('is 2.0.3 in package.json, lockfile, and startup logs', () => {
    expect(pkg.version).toBe('2.0.3')
    expect(lock.version).toBe('2.0.3')
    expect(lock.packages[''].version).toBe('2.0.3')
