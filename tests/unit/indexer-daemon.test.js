...
describe('package version 2.1.4', () => {
  it('is 2.1.4 in package.json, lockfile, and startup logs', () => {
    expect(pkg.version).toBe('2.1.4')
    expect(lock.version).toBe('2.1.4')
    expect(lock.packages[''].version).toBe('2.1.4')
