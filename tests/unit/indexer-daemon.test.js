...
describe('package version 2.0.7', () => {
  it('is 2.0.7 in package.json, lockfile, and startup logs', () => {
    expect(pkg.version).toBe('2.0.7')
    expect(lock.version).toBe('2.0.7')
    expect(lock.packages[''].version).toBe('2.0.7')
