...
export const WRITE_TOOL_HANDLERS = {
  ...
  // Setup-only: live Mail compose that dry_run never performs. Not listed in
  // WRITE_TOOL_DEFINITIONS, so MCP clients never see it.
  mail_automation_probe: () => probeMailAutomation()
};

/** Public MCP write tools. The Mail Automation probe is internal to smoke / ship-gate. */
export const INTERNAL_WRITE_TOOLS = ["mail_automation_probe"];
