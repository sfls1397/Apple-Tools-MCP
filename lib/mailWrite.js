...
import { validateEmailPath, unfoldRfc822Headers, safeMatch } from "./validators.js";
 ...
 */
export function buildComposeScript({ to, cc, bcc, subject, body, send }) {
  const recipients = [
  ...
  set newMessage to make new outgoing message with properties {subject:${asString(subject)}, content:${asString(body)}, visible:false}
  tell newMessage
${recipients}
  end tell
