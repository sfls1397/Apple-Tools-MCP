...
export const CALENDAR_TCC_GUIDANCE =
  "macOS denied Calendar access for this write. Calendar automation is attributed to the process responsible for this MCP server, so a host app " +
  "that cannot hold Calendars access blocks the write regardless of node's Full Disk Access. " +
  "Run the indexer daemon (apple-tools-indexer / the LaunchAgent) so Calendar writes execute under node.";
